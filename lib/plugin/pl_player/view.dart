...
import 'package:bili_plus/pages/video/post_panel/view.dart';
...
import 'package:bili_plus/plugin/pl_player/models/bottom_control_type.dart';
...
import 'package:bili_plus/plugin/pl_player/models/gesture_type.dart';
...
import 'package:bili_plus/plugin/pl_player/widgets/app_bar_ani.dart';
import 'package:bili_plus/plugin/pl_player/widgets/backward_seek.dart';
import 'package:bili_plus/plugin/pl_player/widgets/bottom_control.dart';
import 'package:bili_plus/plugin/pl_player/widgets/common_btn.dart';
import 'package:bili_plus/plugin/pl_player/widgets/forward_seek.dart';
import 'package:bili_plus/plugin/pl_player/widgets/mpv_convert_webp.dart';
...
class _PLVideoPlayerState extends State<PLVideoPlayer>
  ...
  Widget buildBottomControl(
    ...
    List<BottomControlType> userSpecifyItemLeft = [
      ...
      if (anySeason) ...[BottomControlType.pre, BottomControlType.next],
    ];
                    ...
                    child: DecoratedBox(
                      ...
                      child: Obx(() {
                        ...
                        return ComBtn(
                          ...
                          icon: controlsLock
                              ? Icon(
                                  BiliBiliIcons.lock_locked_line500,
                                  size: 25,
                                  color: Colors.white,
                                )
                              : Icon(
                                  BiliBiliIcons.lock_unlock_line500,
                                  size: 25,
                                  color: Colors.white,
                                ),
                          onTap: () =>
