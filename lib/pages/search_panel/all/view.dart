...
import 'package:bili_plus/pages/search_panel/all/controller.dart';
import 'package:bili_plus/pages/search_panel/all/widgets/pgc_card_v_search.dart';
import 'package:bili_plus/pages/search_panel/pgc/widgets/item.dart';
      ...
      delegate: SliverChildBuilderDelegate((_, index) {
        ...
        return switch (list[index]) {
          ...
          List<SearchPgcItemModel> e =>
            e.length == 1
                ? SizedBox(height: 160, child: SearchPgcItem(item: e.first))
                : SizedBox(
                    height:
