import 'package:bili_plus/common/skeleton/whisper_item.dart';
import 'package:bili_plus/common/widgets/loading_widget/http_error.dart';
import 'package:bili_plus/common/widgets/refresh_indicator.dart';
import 'package:bili_plus/grpc/bilibili/app/im/v1.pb.dart';
import 'package:bili_plus/http/loading_state.dart';
import 'package:bili_plus/pages/whisper/widgets/item.dart';
import 'package:bili_plus/pages/whisper_secondary/controller.dart';
                  ...
                  return threeDotItems!
                      .map(
                        (e) => PopupMenuItem(
                          ...
                          child: Row(
                            children: [e.type.icon, Text('  ${e.title}')],
                          ),
                        ),
                      )
                      .toList();
