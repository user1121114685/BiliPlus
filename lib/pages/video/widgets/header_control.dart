...
class HeaderControl extends StatefulWidget {
  ...
  static Future<void> reportLiveDanmaku(
    ...
    if (Accounts.main.isLogin) {
      return autoWrapReportDialog(context, ReportOptions.liveDanmakuReport, (
        reasonType,
        reasonDesc,
        banUid,
      ) {
            ...
            children: [
              ...
              if (widget.videoDetailCtr.cover.value.isNotEmpty)
                ListTile(
                  ...
                  onTap: () {
                    Get.back();
                    ImageUtils.downloadImg(context, [
                          ...
                          child: Column(
                            children: [
                              ...
                              ListTile(
                                ...
                                subtitle: Text(state.audioBitrate.toString()),
                                onTap: () => Utils.copyText(
                                  'AudioBitrate\n${state.audioBitrate}',
                                  needToast: false,
                                ),
  ...
  void showSetDanmaku() {
    ...
    showBottomSheet((context, setState) {
      ...
      void updateDuration(double val) {
        plPlayerController.danmakuDuration = danmakuDuration = val.toPrecision(
          1,
        );
        setState(() {});
        try {
      ...
      void updateStrokeWidth(double val) {
        ...
        try {
          danmakuController?.updateOption(
            danmakuController.option.copyWith(strokeWidth: danmakuStrokeWidth),
          );
        } catch (_) {}
      }
                ...
                Padding(
                  ...
                  child: SliderTheme(
                    ...
                    child: Slider(
                      ...
                      divisions: 20,
                      label: '${(danmakuFontScale * 100).toStringAsFixed(1)}%',
